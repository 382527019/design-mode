...
public class CompositeTest {
    ...
    public static void main(String[] args) {
        ...
        CoursePackage coursePackage2 = new CoursePackage("编程语言--2", 2);
        CoursePackage coursePackage3 = new CoursePackage("编程语言---3", 3);
        CoursePackage coursePackage1 = new CoursePackage("编程语言-1", 1);
